...
The default wording is English, like the rest of the library. Supply a renderer
to say it in the language of the conversation, or to drop the guardrail's name
if end users should not see it:
